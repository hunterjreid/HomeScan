...
"font-size: 23px;")
        ...
        self.pushButton_7.setGeometry(QRect(380, 80, 303, 30))
        icon3 = QIcon()
        icon3.addFile(u"../assets/warning.png", QSize(), QIcon.Normal, QIcon.Off)
...
"border:none;")
        icon4 = QIcon()
        icon4.addFile(u"assets/export.png", QSize(), QIcon.Normal, QIcon.Off)
